...
راجع هذا الفيديو وقرر إذا يستحق النشر على منصة تعليمية عن الذكاء الاصطناعي.

كن صارماً جداً في التقييم. المنصة تعليمية عن AI وليست مدونة عامة.

معايير القبول (8/10 أو أعلى فقط):
- المحتوى يجب أن يكون عن الذكاء الاصطناعي بشكل مباشر وأساسي
- يعلّم المشاهد شيئاً جديداً عن AI أو كيفية استخدامه
- يشرح أدوات AI (مثل ChatGPT, Claude, Midjourney) أو مفاهيم AI
- من قناة موثوقة بمحتوى تعليمي حقيقي

معايير الرفض الصارمة:
- فيديو يستخدم AI كأداة ثانوية (مثل تصميم منيو بـ AI) — هذا ليس محتوى AI تعليمي
- clickbait أو عناوين مبالغ فيها
- فيديو أقل من 5 دقائق (غالباً سطحي)
- محتوى تسويقي لمنتج أو خدمة
- ليس باللغة العربية
- لا يضيف قيمة تعليمية حقيقية عن AI

أجب بصيغة JSON فقط:
{"approved": true/false, "score": 1-10, "reason": "سبب القرار في 2-3 جمل", "summary": "ملخص تفصيلي للفيديو بالعربي في 150-200 كلمة يشمل: موضوع الفيديو، النقاط الرئيسية، ما سيتعلمه المشاهد، ولمن يُنصح بمشاهدته", "category": "news/tutorials/tips/tools"}`;
...
async function main() {
  ...
  for (const video of videos) {
    ...
    if (review.approved && review.score >= 8) {
